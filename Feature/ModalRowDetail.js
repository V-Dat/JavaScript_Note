import { limitHeightAndWidthBody, unlimitHeightAndWidthBody } from './ModalPlaygrounds.js';
...
export function processDataModalDetail(rowData) {
    ...
    rowData.forEach((cellData) => {
      ...
      <h2>${cellData.name === 'note' ? cellData.index - 1 : cellData.index} - ${cellData.name.toUpperCase()}  </h2>
      ${cellData.data}
      </div>
      `;
        }
