import { getRowDataFromDB, getRowDataPrevious, setPreviousActiveRow } from './AccessData.js';
import {
    activeAllButtonEdit,
    activeButtonSave,
    activeButtonUndo,
...
function handleResetRowNoSave(app) {
    if (app.previousActiveRow !== null) {
        const previousRowNode = $$(`tr[data-row-index='${app.previousActiveRow}'] td.column-data.cell`);
